                ...
                <div className="relative z-10 max-w-screen-xl mx-auto px-4 py-28 md:px-8">
                    <div className="space-y-5 max-w-4xl mx-auto text-center">
                        <h2 className="text-4xl text-white font-bold mx-auto md:text-5xl">
                            Tech That Works Smarter — So You Can Too
                        </h2>
                        <p className="max-w-2xl mx-auto text-gray-400">
                            Experience the next generation of innovation with a platform built to simplify your work, accelerate your goals, and inspire your creativity.
                        </p>
                        <form
