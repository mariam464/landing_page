export default () => {
    ...
    return (
        <section id="pricing" className='relative py-14 bg-gray-900'>
            ...
            <div className="relative max-w-screen-xl mx-auto text-gray-300 sm:px-4 md:px-8">
                <div className='max-w-xl mx-auto space-y-3 px-4 sm:text-center sm:px-0'>
                    ...
                    <div className='max-w-xl'>
                        <p>
                            Plans for every stage of your journey from startup to enterprise. Choose the one that fits your needs and scale as you grow.
                        </p>
                    </div>
                </div>
